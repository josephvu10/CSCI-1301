 ...
 *
 * Purpose: Program is used as practice for debugging a program with the three different types of errors
 * program is used to take in the temperature and convert it based on if it fits the appropriate scale
 * If the program receives valid input and scale to work with the program will calculate and display the converted values
 * 
